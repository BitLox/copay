...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      androidsign: {
        command: 'rm -f cordova/project/platforms/android/build/outputs/apk/release/android-release-signed-aligned.apk; jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore ../AUREUS-mobileapps.keystore -signedjar cordova/project/platforms/android/build/outputs/apk/release/android-release-signed.apk  cordova/project/platforms/android/build/outputs/apk/release/android-release-unsigned.apk aureusmobileapps && /Users/player1/Library/Android/sdk/build-tools/25.0.3/zipalign -v 4 cordova/project/platforms/android/build/outputs/apk/release/android-release-signed.apk cordova/project/platforms/android/build/outputs/apk/release/android-release-signed-aligned.apk ',
        stdin: true,
      },
      desktopsign: {
